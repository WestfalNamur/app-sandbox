"""
! DEAD CODE
Used together with: https://github.com/bcherny/json-schema-to-typescript to 
to create schemas form BaseModel: BaseModel => JSONSchema => TypeScript
Interface, but to cumbersome. Maybe do it later. Happy with Runtypes.js
for now.
"""
